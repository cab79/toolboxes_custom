...
for d = 1:length(D)
    ...
    if S.prep.calc.eeg.pca.on
        ...
        if isfield(S.prep.calc.eeg.pca,'use_existing_data') && ~isempty(S.prep.calc.eeg.pca.use_existing_data)
            ...
            Sf.unstandardise_output = S.prep.calc.eeg.pca.unstandardise;
            ...
            Sf.min_corr = S.prep.calc.eeg.cca.min_corr;
            ...
            Sf.cca_select_method = S.prep.calc.eeg.cca.select_method;
            Sf.nCCAadd = S.prep.calc.eeg.cca.test_nCCAadd;
            Sf.randomperm = S.prep.calc.eeg.cca.randomperm;
            Sf.select_freq = S.prep.select.freq;
            Sf.freq_bands = S.prep.freq_bands;
            Sf.freq_pnts = S.prep.freq_pnts;
            Sf.savepth = S.prep.path.outputs;
