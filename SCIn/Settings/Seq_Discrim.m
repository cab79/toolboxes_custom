...
switch opt
    ...
    % settings options
    h.SettingsOptions = {'Discrim_isochron_cues','Discrim_isochron','Discrim_random_cues','Discrim_random','Discrim_isochron_3freqcond','Discrim_isochron_2freqcond','Discrim_rand_reg'};
