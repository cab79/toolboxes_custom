...
if any(strcmp(r.c_obs.responses, 'CCAcomp'))
    ...
    for y=1:size(yr,2)
        ...
        elseif l>1
            logresp = be0 +be1.*surp +be2.*bernv +be3.*inferv +be5.*daureg +be6.*ep1reg +be7.*da1reg +be8.*ep2reg +be12.*m1reg +be13.*m2reg +be15.*sa1reg +be16.*sa2reg;
        else
            logresp = be0 +be1.*surp +be2.*bernv +be5.*daureg +be6.*ep1reg +be7.*da1reg +be8.*ep2reg +be12.*m1reg +be15.*sa1reg;
        end
